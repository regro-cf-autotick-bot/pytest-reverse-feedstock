...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytest-reverse-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13614&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytest-reverse-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytest-reverse` can be installed with:

```
conda install pytest-reverse
```

It is possible to list all of the versions of `pytest-reverse` available on your platform with:
